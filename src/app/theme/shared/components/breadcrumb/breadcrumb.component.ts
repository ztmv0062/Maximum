...
export class BreadcrumbComponent implements OnInit {
  ...
  constructor(private route: Router, public nav: NavigationItem, private titleService: Title,private messageService: MessageService) {
  ...
  filterNavigation(activeLink) {
    ...
    this.titleService.setTitle('SimpleData'+'| Maximum Digital');
  }
