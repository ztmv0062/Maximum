...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(public nav: NavigationItem, private zone: NgZone, private location: Location,private router: Router,private messageService: MessageService) {
    this.nextConfig = NextConfig.config;
    this.windowWidth = window.innerWidth;
    this.navigation =  this.nav.get(this.message);
    this.navigation ;
    ...
    this.subscription = this.messageService.getMessage().subscribe(message => { 
      // console.log(message);
      this.navigation =  this.nav.get(message);
      this.message = message;
     });
  }

  ngOnInit() {
    // console.log('hello nav-content',this.subscription);
    // console.log(this.router.url);
    // console.log('left content',this.message)
  ...
  this.messageService.sendMessage('settings');
  setTimeout(() => {
